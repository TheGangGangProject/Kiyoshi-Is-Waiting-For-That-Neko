...
define config.name = _("Kiyoshi Is Waiting For That Neko")
...
define build.name = "KiyoshiIsWaitingForThatNeko"
...
define config.save_directory = "KiyoshiIsWaitingForThatNeko-1565718249"
